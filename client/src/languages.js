...
export const translations = {
  en: {
    ...
    weatherForecast: "Live & 7-Day Weather Forecast",
    weatherNotice: "Hyperlocal weather data and agricultural harvest & mandi transport advisory",
    weeklyOutlook: "7-Day Whole Week Agricultural Forecast",
    logout: "Logout",
    fullName: "Full Name",
    phone: "Mobile Number",
  ...
  te: {
    ...
    weather: "వాతావరణం",
    weatherForecast: "లైవ్ & 7-రోజుల వాతావరణ అంచనా",
    weatherNotice: "హైపర్‌లోకల్ వాతావరణం, పంట కోత మరియు ధాన్య సేకరణ కేంద్ర రవాణా సలహాలు",
    weeklyOutlook: "7-రోజుల వారపు వ్యవసాయ వాతావరణ సమాచారం",
    logout: "లాగ్ అవుట్",
  ...
  hi: {
    ...
    weatherForecast: "लाइव एवं 7-दिवसीय मौसम पूर्वानुमान",
    weatherNotice: "स्थानीय मौसम डेटा, फसल कटाई और मंडी परिवहन परामर्श",
    weeklyOutlook: "7-दिवसीय साप्ताहिक कृषि मौसम पूर्वानुमान",
    logout: "लॉगआउट",
    fullName: "पूरा नाम",
    phone: "मोबाइल नंबर",
  ...
  ml: {
    ...
    weatherForecast: "തത്സമയ & 7-ദിവസ കാലാവസ്ഥാ പ്രവചനം",
    weatherNotice: "പ്രാദേശിക കാലാവസ്ഥയും കൊയ്ത്ത്-സംഭരണ കേന്ദ്ര ഗതാഗത മുന്നറിയിപ്പുകളും",
    weeklyOutlook: "7-ദിവസത്തെ കാർഷിക കാലാവസ്ഥാ പ്രവചനം",
    logout: "ലോഗ് ഔട്ട്",
